...
from AddyXMusic.utils.database import get_lang, set_lang
from AddyXMusic.utils.decorators import ActualAdminCB, language, languageCB
...
async def language_markup(client, CallbackQuery, _):
    ...
    if str(old) == str(langauge):
        return await CallbackQuery.answer(
            "You're Already Using Same Language Gor This Chat.", show_alert=True
        )
    try:
        ...
        return await CallbackQuery.answer(
            "Failed To Change Language Or The Language Is Under Maintenance.",
            show_alert=True,
        )
