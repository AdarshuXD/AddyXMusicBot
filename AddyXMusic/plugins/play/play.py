...
from AddyXMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from AddyXMusic.core.call import Addy
from AddyXMusic.utils import seconds_to_min, time_to_seconds
from AddyXMusic.utils.channelplay import get_channeplayCB
from AddyXMusic.utils.database import is_video_allowed
from AddyXMusic.utils.decorators.language import languageCB
from AddyXMusic.utils.decorators.play import PlayWrapper
from AddyXMusic.utils.formatters import formats
from AddyXMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from AddyXMusic.utils.inline.playlist import botplaylist_markup
from AddyXMusic.utils.logger import play_logs
from AddyXMusic.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await Addy.stream_call(url)
            except NoActiveGroupCall:
                await mystic.edit_text(
                    "There's An Error In The Bot, Please Report It To Support Chat As Soon As Possible."
                )
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "Please Turn On Video Chats To Steam URL.",
                )
            except Exception as e:
...
@app.on_callback_query(filters.regex("AddyPlaylists") & ~BANNED_USERS)
@languageCB
