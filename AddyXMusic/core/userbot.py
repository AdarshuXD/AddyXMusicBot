    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("U2FNetwork")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("U2FNetwork")
            except:
                pass
            assistants.append(2)
            ...
            try:
                await self.two.send_message(
                    config.LOG_GROUP_ID, f"**» {config.MUSIC_BOT_NAME} Assistant Two Started :**\n\n✨ ID : `{self.two.id}`\n❄ Name : {self.two.name}\n💫 Username : @{self.two.username}"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("U2FNetwork")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("U2FNetwork")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("U2FNetwork")
            except:
                pass
            assistants.append(5)
            ...
            try:
                await self.five.send_message(
                    config.LOG_GROUP_ID, f"**» {config.MUSIC_BOT_NAME} Assistant Five Started :**\n\n✨ ID : `{self.five.id}`\n❄ Name : {self.five.name}\n💫 Username : @{self.five.username}"
                )
            except:
                LOGGER(__name__).error(
