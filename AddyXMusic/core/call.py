...
from AddyXMusic import LOGGER, YouTube, app
...
class Call(PyTgCalls):
    ...
    async def join_call(
        ...
        try:
            ...
            raise AssistantErr(
                "**Assistant Already In Video Chat**\n\nMusic Bot Systems Detected That Assistant Is Already In the Video Chat, If This Problem Continues Restart The Video Chat And Try Again."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**Telegram Server Error**\n\nPlease Turn Off And Restart The Video Chat Again."
            )
